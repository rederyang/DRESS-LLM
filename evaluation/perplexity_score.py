...
#     parser.add_argument('dataset_name', type=str, default='DRC')
...
#     stylized_responses = stylized_responses[200:210] 
...
# # python perplexity_score.py DRC --model_dir "../models/Qwen1.5-14B-Chat"
